...
module.exports = {
    get_teacherstudentsmarks: get_teacherstudentsmarks
};
...
//http://localhost:3000/getteacherstudentsmarks?teacherid=2&subjectid=3&classid=1
function get_teacherstudentsmarks(req, res) {
    ...
    validator_error_value = validator_func({teacherid: teacherid, subjectid: subjectid, classid: classid});
